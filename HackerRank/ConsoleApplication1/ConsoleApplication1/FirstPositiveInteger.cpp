...
int firstPositiveMissing(vector<int> arr) {
	int posCount = segregate(arr);

	for (int i = 0; i < posCount; i++) {
		if (abs(arr[i]) <= posCount && arr[abs(arr[i]) - 1] > 0)
